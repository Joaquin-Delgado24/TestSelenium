...
class RequestTestCase(unittest.TestCase):
    ...
    def test_get_request(self):
        ...
        # Realizar requests
        self.browser.get('https://compuplaza.net.pe/')
        print("==============================================")
        print(self.browser1.execute_script("return $.fn.jquery;"))
        print(self.browser1.execute_script("return $.fn.tooltip.Constructor.VERSION"))
        print("==============================================")
        time.sleep(5)
